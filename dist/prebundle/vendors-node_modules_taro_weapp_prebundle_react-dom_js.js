...
/* harmony export */ });
/* harmony import */ var _chunk_RQETJ4ZT_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-RQETJ4ZT.js */ "./node_modules/.taro/weapp/prebundle/chunk-RQETJ4ZT.js");
/* harmony import */ var _chunk_IWKKQYBA_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-IWKKQYBA.js */ "./node_modules/.taro/weapp/prebundle/chunk-IWKKQYBA.js");
/* harmony import */ var _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-IQGBDCAJ.js */ "./node_modules/.taro/weapp/prebundle/chunk-IQGBDCAJ.js");
...
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-IWKKQYBA.js */ "./node_modules/.taro/weapp/prebundle/chunk-IWKKQYBA.js")["nav"];
...
var require_react_reconciler_production_min = (0,_chunk_3RWA6CQF_js__WEBPACK_IMPORTED_MODULE_3__.__commonJS)({
    "node_modules/react-reconciler/cjs/react-reconciler.production.min.js" (exports, module) {
        module.exports = function $$$reconciler($$$hostConfig) {
            var exports2 = {};
            "use strict";
            var aa = (0,_chunk_RQETJ4ZT_js__WEBPACK_IMPORTED_MODULE_0__.require_react_production_min)(), ba = require_scheduler(), ca = Object.assign;
            function n(a) {
...
(0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.init_shared_esm)();
(0,_chunk_IWKKQYBA_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)();
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_IWKKQYBA_js__WEBPACK_IMPORTED_MODULE_1__.FormElement;
    for(i in newProps){
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.capitalize)((0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && compName in _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.internalComponents) {
        eventName = "tap";
    }
    if ((0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (oldValue) {
...
function setStyle(style, key, value) {
    ...
    style[key] = (0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? value + "px" : value == null ? "" : value;
}
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if ((0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isString)(value)) {
            style.cssText = value;
        } else {
            if ((0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isString)(oldValue)) {
                style.cssText = "";
                oldValue = null;
            }
            if ((0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldValue)) {
            ...
            if ((0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(value)) {
    ...
    } else if (!(0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (value == null) {
...
var hostConfig = {
    ...
    resetAfterCommit: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_IWKKQYBA_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_IWKKQYBA_js__WEBPACK_IMPORTED_MODULE_1__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_IWKKQYBA_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createTextNode(text);
    ...
    beforeActiveInstanceBlur: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    afterActiveInstanceBlur: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    preparePortalMount: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    prepareScopeUpdate: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    getInstanceFromScope: ()=>null,
    getCurrentEventPriority () {
        return import_constants.DefaultEventPriority;
    },
    detachDeletedInstance: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    // -------------------
    //      Microtasks
    //     (optional)
    // -------------------
    supportsMicrotasks: true,
    scheduleMicrotask: (0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isUndefined)(Promise) ? setTimeout : (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }),
    ...
    commitMount: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    resetTextContent: _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
...
function createRoot(domContainer, options = {}) {
    ...
    _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("dispatchTaroEvent", (e, node)=>{
        const eventPriority = getEventPriority(e.type);
        TaroReconciler.runWithPriority(eventPriority, ()=>{
            node.dispatchEvent(e);
        });
    });
    _chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("modifyTaroEvent", (e, node)=>{
        var _a2, _b;
...
function unmountComponentAtNode(dom) {
    (0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_IQGBDCAJ_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
