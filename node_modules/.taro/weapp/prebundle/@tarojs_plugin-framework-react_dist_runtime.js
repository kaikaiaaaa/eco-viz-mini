import { CONTAINER, CONTEXT_ACTIONS, Current, ON_HIDE, ON_READY, ON_SHOW, _raf, addLeadingSlash, document$1, eventCenter, eventHandler, getOnHideEventKey, getOnReadyEventKey, getOnShowEventKey, getPageInstance, getPath, incrementId, init_runtime_esm, injectPageInstance, removePageInstance, safeExecute, window$1 } from "./chunk-IWKKQYBA.js";
import { EMPTY_OBJ, ensure, hooks, init_shared_esm, isArray, isFunction, isUndefined } from "./chunk-IQGBDCAJ.js";
...
function createReactApp(App, react, dom, config) {
    ...
    function renderReactRoot() {
        ...
        let container = document$1.getElementById(appId);
        if (container == null) {
            const appContainer = document$1.getElementById(CONTAINER);
        ...
        properties: {
            props: {
                ...
                observer (_newVal, oldVal) {
                    var _a2, _b2, _c, _d;
                    if (false) {
                        const inst = document$1.getElementById(this.id);
