import { __esm } from "./chunk-3RWA6CQF.js";
...
var DEFAULT_EMPTY_ARRAY, NO_DEFAULT_VALUE, DEFAULT_TRUE, DEFAULT_FALSE, touchEvents, animation, View, Icon, MapComp, Progress, RichText, Text, Button, Checkbox, CheckboxGroup, Form, Input, Label, Picker, PickerView, PickerViewColumn, Radio, RadioGroup, Slider, Switch, Textarea, CoverImage, CoverView, MovableArea, MovableView, ScrollView, Swiper, SwiperItem, Navigator, Audio, Camera, Image, LivePlayer, Video, Canvas, Ad, WebView, Block, SlotView, Slot, NativeSlot, Script, internalComponents, controlledComponent, PLATFORM_TYPE, PLATFORM_CONFIG_MAP, Events, PageEvts, pageChannel, RouteEvts, routeChannel, isArray, HOOK_TYPE, defaultMiniLifecycle, TaroHooks, hooks, EMPTY_OBJ, noop, _uniqueId, _loadTime, needPromiseApis, Shortcuts;
...
export { internalComponents, controlledComponent, Events, isString, isUndefined, isNull, isObject, isBoolean, isFunction, isNumber, isArray, hooks, EMPTY_OBJ, noop, toDashed, toCamelCase, capitalize, ensure, warn, mergeInternalComponents, getComponentsAlias, mergeReconciler, processApis, init_shared_esm };
